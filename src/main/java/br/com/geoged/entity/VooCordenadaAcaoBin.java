...
public class VooCordenadaAcaoBin implements Serializable {
  ...
  @GeneratedValue(strategy = GenerationType.SEQUENCE,
      generator = SchemaUtil.DEFAULT + ".seq_voocordenadaacaobin")
  ...
  public int hashCode() {
    ...
    result = prime * result + Objects.hash(dataRegistro, extensao, id, mimeType, nomeArquivo,
        tenantId, tipo, valorClob);
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(dataRegistro, other.dataRegistro)
        && Objects.equals(extensao, other.extensao) && Objects.equals(id, other.id)
        && Objects.equals(mimeType, other.mimeType)
        && Objects.equals(nomeArquivo, other.nomeArquivo)
        && Objects.equals(tenantId, other.tenantId) && Objects.equals(tipo, other.tipo)
        && Arrays.equals(valorBlob, other.valorBlob) && Objects.equals(valorClob, other.valorClob);
  }

  @Override
  public String toString() {
    return "VooCoordenadaAcaoBin [id=" + id + ", tenantId=" + tenantId + ", tipo=" + tipo
        + ", nomeArquivo=" + nomeArquivo + ", extensao=" + extensao + ", mimeType=" + mimeType
        + ", valorClob=" + valorClob + ", valorBlob=" + Arrays.toString(valorBlob)
