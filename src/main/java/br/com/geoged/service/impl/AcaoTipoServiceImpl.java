...
public class AcaoTipoServiceImpl extends ServiceBaseImpl<AcaoTipo> implements AcaoTipoService {
	...
	private final AcaoTipoRepository acaoTipoRepository;
	...
	public List<AcaoTipo> findByTenantId(Integer tenantId) throws GeoGedException {
		return Optional.of(acaoTipoRepository.findByTenant_id(tenantId))
				.orElseThrow(() -> new RegistroExistsException());
	}

	@Override
	public AcaoTipo findByNome(Integer tenantId, String nome) {
		return Optional.of(acaoTipoRepository.findByNome(tenantId, nome))
				.orElseThrow(() -> new GeoGedException("sem.dados"));
	}
