...
public class VooCordenadaAcaoServiceImpl extends ServiceBaseImpl<VooCordenadaAcao> implements VooCordenadaAcaoService {
	...
	private final VooCordenadaAcaoRepository vooCordenadaAcaoRepository;
	...
	public VooCordenadaAcaoDTO saveDTO(VooCordenadaAcaoDTO dto) {
		VooCordenadaAcao tmp = vooCordenadaAcaoRepository.findByTenantIAndAIdVooCordenadaAndIdAcaoTipoAndDataRegistro(
				dto.getTenant_id(), dto.getIdVooCordenada(), dto.getIdAcaoTipo(), dto.getDataRegistro());
		if (tmp == null) {
